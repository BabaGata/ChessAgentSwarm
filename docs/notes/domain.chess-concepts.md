...
| "10,000 hours / deliberate practice determines skill" | `measured` but **partial** — meta-analytic work reports deliberate practice explaining roughly a third of skill variance in chess, not all of it | Directly affects what the swarm may honestly promise about progress |
