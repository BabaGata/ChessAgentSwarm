...
| Tool | Status | Purpose | Notes |
|---|:--:|---|---|
| Lichess API | candidate | player games, ratings, puzzle history | free, open |
| Lichess open database | candidate | bulk games, puzzles with motif tags, opening explorer | free, very large |
