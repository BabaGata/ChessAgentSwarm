...
| E25 | is a weakness the whole band shares still worth coaching? | done — **for 5 claims of 27**, including the most expensive one measured (`instant_move_error`), which is advised to nobody. **Re-screened 2026-08-20 on the full-size reference: 3 of 32 survive, and the headline costs the median player 22.8/game, not the 16.1 recorded then** | [[experiments.e25-shared-weaknesses]] |
