...
| C5 (auditable) + success criterion 6 (reproducible from this vault) | M6 — the vault is updated and committed every cycle, so the project can be reconstructed from its record. |
