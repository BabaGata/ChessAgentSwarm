...
- how the player interacts with the swarm;
...
**Gap watch:** M1–M7 do not explicitly schedule work on *player-facing interaction quality* beyond
M3's design. If the swarm turns out to be good at analysis but bad at communicating, this mission
needs a dedicated step. Flagged here so it is not silently dropped.

## Progress

| Step | Status | Note |
|---|---|---|
| M1 | wip | [[mission.step-01-foundations]] |
| M2 | pending | |
| M3 | pending | |
| M4 | pending | |
| M5 | pending | |
