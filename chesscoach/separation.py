...
DOES_NOT_SEPARATE: dict[str, Separation] = {
    ...
    "allowed_motif.capturingDefender.own": Separation(1.15, 0.221, 1.15, 50, conclusive=True),  # 1400-1800|blitz
    ...
    "allowed_motif.trappedPiece.own": Separation(1.20, 0.161, 1.20, 49, conclusive=True),  # 1400-1800|blitz
    "concedes_weakness.backward.own": Separation(1.06, 0.353, 1.23, 50, conclusive=True),  # 1400-1800|blitz
    "allowed_motif.fork.own": Separation(1.25, 0.116, 1.23, 50, conclusive=True),  # 1400-1800|blitz
