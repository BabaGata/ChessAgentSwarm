...
# 25 claims; 19 conclusive, 6 inconclusive
...
DOES_NOT_SEPARATE: dict[str, Separation] = {
    ...
    "concedes_weakness.any.own": Separation(1.17, 0.195, 1.13, 50, conclusive=True),  # 1400-1800|blitz
    ...
    "miscounted_exchange.own_move.own": Separation(1.04, 0.394, 1.47, 50, conclusive=False),  # 1400-1800|blitz
